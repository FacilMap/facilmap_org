...
function initMap()
{
	...
	el4.value = OpenLayers.Layer.cdauth.XML.Routing.Type.FASTEST;
	el4.appendChild(document.createTextNode(OpenLayers.i18n("Fastest")));
	el3.appendChild(el4);
	el4 = document.createElement("option");
	el4.value = OpenLayers.Layer.cdauth.XML.Routing.Type.SHORTEST;
	...
	el4 = document.createElement("option");
	el4.value = OpenLayers.Layer.cdauth.XML.Routing.Medium.CAR;
	el4.appendChild(document.createTextNode(OpenLayers.i18n("Car")));
	el3.appendChild(el4);
	el4 = document.createElement("option");
	el4.value = OpenLayers.Layer.cdauth.XML.Routing.Medium.BICYCLE;
	el4.appendChild(document.createTextNode(OpenLayers.i18n("Bicycle")));
	el3.appendChild(el4);
	el4 = document.createElement("option");
	el4.value = OpenLayers.Layer.cdauth.XML.Routing.Medium.FOOT;
